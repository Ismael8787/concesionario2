...
class VendedorResourceIT {
    ...
    void createVendedor() throws Exception {
        ...
        assertThat(testVendedor.getApellido1()).isEqualTo(DEFAULT_APELLIDO_1);
        assertThat(testVendedor.getApellido2()).isEqualTo(DEFAULT_APELLIDO_2);
    ...
    @Test
    @Transactional
    void checkFechaBajaIsRequired() throws Exception {
        int databaseSizeBeforeTest = vendedorRepository.findAll().size();
        // set the field null
        vendedor.setFechaBaja(null);
    ...
    void putNewVendedor() throws Exception {
        ...
        assertThat(testVendedor.getApellido1()).isEqualTo(UPDATED_APELLIDO_1);
        assertThat(testVendedor.getApellido2()).isEqualTo(UPDATED_APELLIDO_2);
    ...
    void partialUpdateVendedorWithPatch() throws Exception {
        ...
        partialUpdatedVendedor.nombre(UPDATED_NOMBRE).fechaBaja(UPDATED_FECHA_BAJA);
