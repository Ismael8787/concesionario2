...
/**
 * REST controller for managing {@link es.melit.concesionario2.domain.Vendedor}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class VendedorResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/vendedors/{id}", consumes = "application/merge-patch+json")
    public ResponseEntity<Vendedor> partialUpdateVendedor(
        ...
        Optional<Vendedor> result = vendedorRepository
            ...
            .map(
                existingVendedor -> {
                    ...
                    if (vendedor.getApellido1() != null) {
                        existingVendedor.setApellido1(vendedor.getApellido1());
                    }
                    if (vendedor.getApellido2() != null) {
                        existingVendedor.setApellido2(vendedor.getApellido2());
                    }
    ...
    public ResponseEntity<List<Vendedor>> getAllVendedors(Pageable pageable) {
        ...
        Page<Vendedor> page = vendedorRepository.findAll(pageable);
