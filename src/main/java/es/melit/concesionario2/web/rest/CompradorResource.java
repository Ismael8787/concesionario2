...
public class CompradorResource {
    ...
    public CompradorResource(CompradorRepository compradorRepository) {
    ...
    public ResponseEntity<Comprador> createComprador(@Valid @RequestBody Comprador comprador) throws URISyntaxException {
        ...
        Comprador result = compradorRepository.save(comprador);
    ...
    public ResponseEntity<Comprador> partialUpdateComprador(
        ...
        Optional<Comprador> result = compradorRepository
            ...
            .map(
                existingComprador -> {
                    ...
                    if (comprador.getApellido1() != null) {
                        existingComprador.setApellido1(comprador.getApellido1());
                    }
                    if (comprador.getApellido2() != null) {
                        existingComprador.setApellido2(comprador.getApellido2());
                    }
    ...
    public ResponseEntity<List<Comprador>> getAllCompradors(Pageable pageable) {
        ...
        Page<Comprador> page = compradorRepository.findAll(pageable);
